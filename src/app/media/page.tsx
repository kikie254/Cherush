...
export const metadata = getMetadata({
  title: 'Media Mentions & Awards | Cherush Guesthouse',
  description: 'Cherush Guesthouse in the news and our awards for hospitality excellence.',
  path: '/media',
})

const breadcrumbs = getBreadcrumbSchema([
  { name: 'Home', item: '/' },
  { name: 'Media Mentions & Awards', item: '/media' }
])
      ...
      <main className="min-h-screen bg-background pt-32 pb-20">
        <Container>
          <SectionHeading
            ...
            title="Media Mentions & Awards"
            body="Cherush Guesthouse in the news and our awards for hospitality excellence."
          />
