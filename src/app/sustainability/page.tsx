...
export const metadata = getMetadata({
  title: 'Sustainability | Cherush Guesthouse',
  description: 'Our commitment to eco-friendly practices in Elgeyo Marakwet.',
  path: '/sustainability',
})
      ...
      <main className="min-h-screen bg-background pt-32 pb-20">
        <Container>
          <SectionHeading
            ...
            body="Our commitment to eco-friendly practices in Elgeyo Marakwet."
          />
