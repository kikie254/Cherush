...
export const metadata = getMetadata({
  title: 'Meet Our Team | Cherush Guesthouse',
  description: 'Meet the passionate team behind Cherush Guesthouse Iten.',
  path: '/team',
})

const breadcrumbs = getBreadcrumbSchema([
  { name: 'Home', item: '/' },
  { name: 'Meet Our Team', item: '/team' }
])
      ...
      <main className="min-h-screen bg-background pt-32 pb-20">
        <Container>
          <SectionHeading
            ...
            title="Meet Our Team"
            body="Meet the passionate team behind Cherush Guesthouse Iten."
          />
