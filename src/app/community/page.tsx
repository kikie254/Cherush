...
export const metadata = getMetadata({
  title: 'Community Involvement | Cherush Guesthouse',
  description: 'How Cherush Guesthouse supports local athletes and the Iten community.',
  path: '/community',
})

const breadcrumbs = getBreadcrumbSchema([
  { name: 'Home', item: '/' },
  { name: 'Community Involvement', item: '/community' }
])
      ...
      <main className="min-h-screen bg-background pt-32 pb-20">
        <Container>
          <SectionHeading
            ...
            body="How Cherush Guesthouse supports local athletes and the Iten community."
          />
