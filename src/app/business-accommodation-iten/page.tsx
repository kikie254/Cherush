...
export const metadata = getMetadata({
  title: 'Business Accommodation in Iten | Cherush Guesthouse',
  description: 'High-speed fiber WiFi, quiet workspaces, and premium service for business travelers visiting Elgeyo Marakwet County.',
  path: '/business-accommodation-iten',
})

const breadcrumbs = getBreadcrumbSchema([
  { name: 'Home', item: '/' },
  { name: 'Business Accommodation in Iten', item: '/business-accommodation-iten' }
])
    ...
    <>
      ...
      <article className="min-h-screen bg-background">
        ...
        <section className="relative h-[60vh] flex items-center justify-center">
          <Image src="https://images.unsplash.com/photo-1542401886-65d6c61db217?auto=format&fit=crop&q=80&w=2000" alt="Premium Business Accommodation in Iten" fill className="object-cover brightness-50" priority />
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            <h1 className="font-display text-4xl md:text-6xl font-bold text-white mb-6">Premium Business Accommodation in Iten</h1>
            <p className="text-xl text-white/90 font-light max-w-2xl mx-auto">High-speed fiber WiFi, quiet workspaces, and premium service for business travelers visiting Elgeyo Marakwet County.</p>
        ...
        <section className="py-20 px-4 max-w-5xl mx-auto">
          ...
          <div className="bg-accent/10 border-l-4 border-accent p-6 rounded-r-xl mb-12">
            <h2 className="text-xl font-bold text-primary mb-2">Why Choose Cherush for Business Accommodation?</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="prose prose-lg prose-headings:font-display prose-headings:text-primary max-w-none">
              ...
              <p>When searching for <strong>business accommodation in iten</strong>, you need a place that understands your unique requirements. At Cherush Guesthouse, we go beyond basic lodging. We provide a sanctuary.</p>
