...
export const metadata = getMetadata({
  title: 'Conference Venue in Iten | Cherush Guesthouse',
  description: 'Host your next meeting, retreat, or seminar in our fully-equipped conference facilities at Cherush Guesthouse Iten.',
  path: '/conference-venue-iten',
})

const breadcrumbs = getBreadcrumbSchema([
  { name: 'Home', item: '/' },
  { name: 'Conference Venue in Iten', item: '/conference-venue-iten' }
])
    ...
    <>
      ...
      <article className="min-h-screen bg-background">
        ...
        <section className="relative h-[60vh] flex items-center justify-center">
          <Image src="https://images.unsplash.com/photo-1542401886-65d6c61db217?auto=format&fit=crop&q=80&w=2000" alt="Professional Conference Venue in Iten" fill className="object-cover brightness-50" priority />
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            <h1 className="font-display text-4xl md:text-6xl font-bold text-white mb-6">Professional Conference Venue in Iten</h1>
            <p className="text-xl text-white/90 font-light max-w-2xl mx-auto">Host your next meeting, retreat, or seminar in our fully-equipped conference facilities at Cherush Guesthouse Iten.</p>
        ...
        <section className="py-20 px-4 max-w-5xl mx-auto">
          ...
          <div className="bg-accent/10 border-l-4 border-accent p-6 rounded-r-xl mb-12">
            <h2 className="text-xl font-bold text-primary mb-2">Why Choose Cherush for Conference Venue?</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="prose prose-lg prose-headings:font-display prose-headings:text-primary max-w-none">
              ...
              <p>When searching for <strong>conference venue in iten</strong>, you need a place that understands your unique requirements. At Cherush Guesthouse, we go beyond basic lodging. We provide a sanctuary.</p>
