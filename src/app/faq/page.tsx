...
export const metadata = getMetadata({
  title: 'Frequently Asked Questions | Cherush Guesthouse',
  description: 'Everything you need to know about staying at Cherush Guesthouse.',
  path: '/faq',
})
      ...
      <main className="min-h-screen bg-background pt-32 pb-20">
        <Container>
          <SectionHeading
            ...
            body="Everything you need to know about staying at Cherush Guesthouse."
          />
