...
export const metadata = getMetadata({
  title: 'House Rules | Cherush Guesthouse',
  description: 'Guidelines to ensure a peaceful, respectful, and safe environment for all guests.',
  path: '/house-rules',
})
...
export default function Page() {
  return (
    <main className="min-h-screen bg-background pt-32 pb-20 px-4 max-w-4xl mx-auto">
      <h1 className="font-display text-4xl md:text-5xl font-bold text-primary mb-8">House Rules</h1>
      <div className="prose prose-lg prose-headings:font-display prose-headings:text-primary max-w-none bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-primary/5">
        <p className="lead">Guidelines to ensure a peaceful, respectful, and safe environment for all guests.</p>
