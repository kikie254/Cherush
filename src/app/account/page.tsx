    ...
    <section className="py-20">
      <Container className="space-y-10">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <SectionHeading eyebrow="Account" title="Guest booking history" body="This seed build shows example booking history. Connect Supabase to display real user-specific stays." />
          <SignOutButton />
        </div>
