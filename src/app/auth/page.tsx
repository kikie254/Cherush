  ...
  return (
    <section className="py-20">
      <Container className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
        <SectionHeading eyebrow="Guest account" title="Sign in to manage stays" body="Enable Firebase credentials to activate full email/password and Google authentication." />
