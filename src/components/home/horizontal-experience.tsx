...
export function HorizontalExperience() {
  ...
  return (
    <section ref={targetRef} className="relative h-[300vh] bg-primary" aria-label="The Cherush Experience">
      <div className="sticky top-0 h-screen flex flex-col justify-center overflow-hidden">
        <Container className="mb-12 md:mb-20">
          ...
          <h2 className="mt-6 font-display text-4xl md:text-6xl text-white tracking-tight">
            The Cherush Experience
          </h2>
        </Container>

        {/* GPU-composited horizontal scroll strip */}
        <motion.div
          style={{ x }}
          className="flex pl-4 md:pl-[max(2rem,calc((100vw-80rem)/2))] gap-8 md:gap-16 pb-20 parallax-layer"
        >
